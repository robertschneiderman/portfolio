...
<head>
    ...
    <section class="landing l-landing">
        <div id="modal" class="modal">
            <svg id="modal-close-btn" class="modal__btn"><use xlink:href="<%= sprites %>svgsprite.svg#x"></use></svg>  
            <?php 
        ...
        <svg class="img--headline sm"><use xlink:href="<%= sprites %>svgsprite.svg#headline-sm"></use></svg>
        <svg class="img--headline md"><use xlink:href="<%= sprites %>svgsprite.svg#headline"></use></svg>
    </section>
    ...
    <section class="about-me">
        ...
        <!-- <svg class="img--globe"><use xlink:href="<%= sprites %>svgsprite.svg#globe"></use></svg> -->
        ...
        <div class="work-c">
            <div class="figure--work">
                <a href="work/progressive-care/" rel="external">
                    <img class="figure--work__img lazyload" data-sizes="auto" data-src="<%= srcset %>ac.jpg" data-srcset="<%= srcset %>pc-sm.jpg 350w, <%= srcset %>pc-md.jpg 425w, <%= srcset %>pc-lg.jpg 500w, <%= srcset %>pc-sm@2x.jpg 700w, <%= srcset %>pc-md@2x.jpg 850w, <%= srcset %>pc-lg@2x.jpg 1000w">                         
                    <div class="figure--work__overlay">
                        <svg class=""><use xlink:href="<%= sprites %>svgsprite.svg#link"></use></svg>
                    </div>
                </a>                          
            </div>&nbsp;
            <div class="figure--work">
                <a href="work/bayonne/" rel="external">
                    <img class="figure--work__img lazyload" data-sizes="auto" data-src="<%= srcset %>bayonne.jpg" data-srcset="<%= srcset %>bayonne-sm.jpg 350w, <%= srcset %>bayonne-md.jpg 425w, <%= srcset %>bayonne-lg.jpg 500w, <%= srcset %>bayonne-sm@2x.jpg 700w, <%= srcset %>bayonne-md@2x.jpg 850w, <%= srcset %>bayonne-lg@2x.jpg 1000w">
                    <div class="figure--work__overlay">
                        <svg class=""><use xlink:href="<%= sprites %>svgsprite.svg#link"></use></svg>
                    </div>
                </a>                                    
            ...
            <div class="figure--work">
                <a href="work/new-haven-ortho-sports-medicine/" rel="external">
                    <img class="figure--work__img lazyload" data-sizes="auto" data-src="<%= srcset %>new-haven-sports-ortho.jpg" data-srcset="<%= srcset %>new-haven-sports-ortho-sm.jpg 350w, <%= srcset %>new-haven-sports-ortho-md.jpg 425w, <%= srcset %>new-haven-sports-ortho-lg.jpg 500w, <%= srcset %>new-haven-sports-ortho-sm@2x.jpg 700w, <%= srcset %>new-haven-sports-ortho-md@2x.jpg 850w, <%= srcset %>new-haven-sports-ortho-lg@2x.jpg 1000w">
                    <div class="figure--work__overlay">
                        <svg class=""><use xlink:href="<%= sprites %>svgsprite.svg#link"></use></svg>
                    </div>
                </a>               
