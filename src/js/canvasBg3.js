(function(){
    var canvasBody = document.getElementById("canvas3"),
            canvas = canvasBody.getContext("2d"),
            
            w = canvasBody.width = window.innerWidth, //Full width
            h = canvasBody.height = (window.innerHeight * .9), //Full height
            ...
            communicatePoints = function(point1, father){ 
                for(var i = 0; i < father.length; i++){
                    ...
                    if (opacity > 0){ //Draws the line
                        ...
                        canvas.strokeStyle = "rgba(122,214,238,opacity)".replace("opacity", opacity);
                        canvas.beginPath();
