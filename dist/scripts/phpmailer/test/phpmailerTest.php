...
class PHPMailerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testMultiplePlainFileAttachment()
    {
        ...
        if (!$this->Mail->addAttachment('../examples/<?php bloginfo( 'template_url' ); ?>/images/phpmailer.png')) {
...
EOT;
        $this->Mail->addEmbeddedImage(
            '../examples/<?php bloginfo( 'template_url' ); ?>/images/phpmailer.png',
            'my-attach',
            'phpmailer.png',
            'base64',
            'image/png'
...
EOT;
    ...
    public function testHTMLAttachment()
    {
        ...
        if (!$this->Mail->addAttachment('../examples/<?php bloginfo( 'template_url' ); ?>/images/phpmailer_mini.png', 'phpmailer_mini.png')) {
            $this->assertTrue(false, $this->Mail->ErrorInfo);
            return;
        }
    ...
    public function testHTMLStringEmbedNoName()
    {
        ...
        if (!$this->Mail->addStringEmbeddedImage(
            file_get_contents('../examples/<?php bloginfo( 'template_url' ); ?>/images/phpmailer_mini.png'),
    ...
    public function testHTMLMultiAttachment()
    {
        ...
        if (!$this->Mail->addAttachment('../examples/<?php bloginfo( 'template_url' ); ?>/images/phpmailer.png', 'phpmailer.png')) {
            $this->assertTrue(false, $this->Mail->ErrorInfo);
            return;
        }
