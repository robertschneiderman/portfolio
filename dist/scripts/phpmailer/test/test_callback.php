...
try {
    ...
    $mail->addAttachment('../examples/<?php bloginfo( 'template_url' ); ?>/images/phpmailer.png'); // attachment
    $mail->addAttachment('../examples/<?php bloginfo( 'template_url' ); ?>/images/phpmailer_mini.png'); // attachment
